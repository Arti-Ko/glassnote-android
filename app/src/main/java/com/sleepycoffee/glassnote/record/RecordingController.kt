...
import com.sleepycoffee.glassnote.transcription.PendingTranscriber
...
/** Единый оркестратор записи/расшифровки/хранилища. Делит состояние между
 *  сервисом, плиткой, плашкой и главным окном. */
object RecordingController {
    private lateinit var appContext: Context
    lateinit var store: NoteStore; private set
    private lateinit var recorder: AudioRecorder
    var transcriber: Transcriber = PendingTranscriber()
    ...
    /** Простой поиск-подстрока для v1 (на macOS — SQLite FTS5; здесь как fallback). */
